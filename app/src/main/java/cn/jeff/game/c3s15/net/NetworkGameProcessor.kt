...
/*
	...
	@Volatile
	var state = NetGameState.OFFLINE
		private set(value) {
			field = value
			EventBus.getDefault().post(NetGameStateChangedEvent(value))
		}

	@Volatile
	private var restarting = false

	private val cannonsPlayerType get() = GlobalVars.cannonsPlayerType
	private val soldiersPlayerType get() = GlobalVars.soldiersPlayerType
	private val localChessBoardContent get() = GlobalVars.chessBoardContent
